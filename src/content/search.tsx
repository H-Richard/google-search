...
export const searchResults: Content[] = [
  {
    ...
    image: <Image src="https://avatars.githubusercontent.com/u/69631?s=200&v=4" alt="meta logo" layout="fill" objectFit="contain" priority />,
  },
  {
    title: 'Coinbase | Software Engineer',
    descripiption: <></>,
    link: 'https://www.coinbase.com/card/',
    image: <Image src="https://avatars.githubusercontent.com/u/1885080?s=200&v=4" alt="amazon logo" layout="fill" objectFit="contain" priority />,
  },
  {
    title: 'University of Toronto | Researcher',
    descripiption: <></>,
    link: 'http://csslab.cs.toronto.edu/research/',
    image: <Image src="https://avatars.githubusercontent.com/u/33668513?s=200&v=4" alt="uoft logo" layout="fill" objectFit="contain" priority />,
  },
  {
    title: 'Shopify | Software Developer Intern',
    descripiption: <></>,
    link: 'https://www.shopify.com/plus/solutions/ecommerce-automation/',
    image: <Image src="https://avatars.githubusercontent.com/u/8085?s=200&v=4" alt="shopify logo" layout="fill" objectFit="contain" priority />,
  },
  {
  ...
  },
  {
    ...
    image: <Image src="https://avatars.githubusercontent.com/u/8594673?s=200&v=4" alt="amazon logo" layout="fill" objectFit="contain" priority />,
  },
  {
  ...
  },
  {
    ...
    image: <Image src="https://avatars.githubusercontent.com/u/48692442?s=200&v=4" alt="ibm logo" layout="fill" objectFit="contain" priority />,
  },
  {
