...
export const skills = [
  ...
  },
  {
    ...
    type: 'LANGUAGE',
    category: 'BACKEND',
    history: [0, 0, 11, 13, 8, 6, 21, 24, 20, 18, 26, 31, 32, 56, 55],
  },
  {
    symbol: 'JAVA',
    name: 'Java',
  ...
  },
  {
    ...
    category: 'FRONTEND',
    history: [
      1, 10, 40, 37, 32, 55, 50, 80, 78, 73, 92, 91, 95, 96, 85, 72, 74,
    ],
  },
  {
    symbol: 'RN',
  ...
  },
  {
    ...
    type: 'FRAMEWORK',
    category: 'MOBILE',
    history: [0, 0, 0, 10, 26, 47, 42, 39, 37, 34, 32, 31, 29, 35, 40, 32],
  },
  {
    category: 'FRONTEND',
    name: 'NextJS',
  ...
  },
  {
    ...
    symbol: 'FLASK',
    type: 'FRAMEWORK',
    history: [1, 5, 22, 20, 18, 16, 37, 35, 40, 39, 38, 70, 60, 55],
  },
  {
    category: 'ML',
    name: 'PyTorch',
  ...
  },
  {
    ...
    symbol: <>&lambda;</>,
    type: 'CLOUD',
    history: [10, 35, 52, 47, 36, 33, 43, 56],
  },
  {
    category: 'INFRA',
    name: 'S3',
  ...
  },
  {
    ...
    symbol: 'RDS',
    type: 'CLOUD',
    history: [12, 20, 41, 63, 55, 63, 67, 68, 60],
  },
  {
    category: 'INFRA',
    name: 'GCP',
    symbol: 'GCP',
    type: 'CLOUD',
    history: [3, 14, 17, 24, 22, 32, 30, 28, 34, 38, 42, 40, 38, 46],
  },
  {
    category: 'INFRA',
    name: 'Cloud SQL',
    symbol: 'CSQL',
    type: 'CLOUD',
    history: [4, 13, 25, 35, 32, 28, 20, 22, 20, 26, 20],
  },
  {
    category: 'DATA',
    name: 'Athena',
  ...
  },
  {
    ...
    symbol: 'K8S',
    type: 'TOOL',
    history: [1, 12, 14, 18, 19, 32, 31, 34, 39, 42, 39, 41, 42, 43, 47, 42],
  },
  {
    category: 'DATABASE',
    name: 'PostgreSQL',
