...
const about = (
  <svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={styles.about}>
      ...
      <div className={styles.header}>
        <div className={styles.title}>
          <div className={styles.headshot}>
            <Image src="/images/1.png" alt="profile picture" height={56} width={42.1} />
          </div>
